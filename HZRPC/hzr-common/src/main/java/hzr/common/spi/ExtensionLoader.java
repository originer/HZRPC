package hzr.common.spi;

import hzr.common.spi.annotation.SPI;
...
public class ExtensionLoader<T> {
     ...
     */
    private static final String FEI_CHAO_DIRECTORY = "META-INF/feichao/";
    ...
    /**
     * 设置默认实现 cachedDefaultName 并加载文件
     *
     * @return
     */
    private Map<String, Class<?>> loadExtensionClasses() {
        ...
        loadFile(extensionClasses, FEI_CHAO_DIRECTORY);
